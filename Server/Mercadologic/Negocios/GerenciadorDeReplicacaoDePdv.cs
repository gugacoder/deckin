...
using Mercadologic.Negocios.Algoritmos;
using Keep.Paper.Api;
using Keep.Tools;
using Keep.Tools.Collections;
using Keep.Tools.Sequel;
using Keep.Tools.Sequel.Runner;
using Mercadologic.Negocios.Algoritmos.Replicacao;
using Mercadologic.Dominio.Director.mlogic;

namespace Mercadologic.Negocios
{
  public class GerenciadorDeReplicacaoDePdv
  {
    ...
    public GerenciadorDeReplicacaoDePdv(DbDirector dbDirector,
